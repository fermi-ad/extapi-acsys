...
fn to_info_result(item: &devdb::proto::InfoEntry) -> global::DeviceInfoResult {
    match &item.result {
        // If the `InfoEntry` contains device information, transfer
        // the information.
        Some(devdb::proto::info_entry::Result::Device(di)) => {
            global::DeviceInfoResult::DeviceInfo(global::DeviceInfo {
                description: di.description.clone(),
                reading: di.reading.as_ref().map(|p| global::ReadingProp {
                ...
                setting: di.setting.as_ref().map(|p| global::SettingProp {
                    primary_units: p.primary_units.clone(),
                    common_units: p.common_units.clone(),
                    min_val: p.min_val,
                    max_val: p.max_val,
                ...
                dig_status: di.dig_status.as_ref().map(|p| global::DigStatus {
        ...
        // `None`.
        None => global::DeviceInfoResult::ErrorReply(global::ErrorReply {
...
fn xlat_expr(expr: &global::XFormExpr) -> Option<Box<xform::proto::Operation>> {
    match expr {
        global::XFormExpr {
            dev_ex: Some(global::XFormDeviceExpr { device }),
            avg_ex: None,
        ...
        global::XFormExpr {
            dev_ex: None,
            avg_ex: Some(global::XFormAvgExpr { expr, n }),
        } => Some(Box::new(xform::proto::Operation {
...
impl Subscriptions {
    ...
    async fn calc_stream(&self, config: global::XFormRequest) -> XFormStream {
