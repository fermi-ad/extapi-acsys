...
#[doc = "Fermilab tracks the amount of beam transferred through various \
	 beamlines. There is a limit that can be transmitted in order to \
	 control the amount of radiation that is generated. These queries \
	 return information related to the Beam Budget monitoring systems."]
#[Object]
impl BbmQueries {
